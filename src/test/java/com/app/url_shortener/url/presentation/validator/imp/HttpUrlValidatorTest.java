...
class HttpUrlValidatorTest {
  ...
  class ValidationTests {
    ...
    @DisplayName(
        "Deve retornar falso para URIs inválidas, sem host, com userinfo, porta ou esquema inválido")
    void shouldReturnFalseForInvalidUrisMissingHostUserInfoInvalidPortOrUnsupportedSchemes(
        String value) {
      // 1. Arrange
