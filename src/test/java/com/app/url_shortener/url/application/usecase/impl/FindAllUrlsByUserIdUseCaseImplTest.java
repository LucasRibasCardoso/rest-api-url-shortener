...
class FindAllUrlsByUserIdUseCaseImplTest {
  ...
  @InjectMocks private FindAllUrlsByUserIdUseCaseImpl findAllUrlsByUserIdUseCase;
  ...
  class ExecuteTests {
    ...
    void shouldFindUrlsByUserIdWithPaginationAndReturnRepositoryResult() {
      ...
      when(urlRepositoryPort.findAllByUserId(userId, limit, cursor, status))
          .thenReturn(pageUrlResult);
