...
public class RefreshTokenCleanupTask {
  ...
  /**
   * Roda automaticamente todos os dias às 03:00 da manhã. O formato Cron é: "Segundo Minuto Hora
   * Dia Mes DiaDaSemana" O formato Cron é: "Segundo Minuto Hora Dia Mes DiaDaSemana"
   */
  ...
  public void cleanupExpiredTokens() {
    ...
    log.info(
        "Rotina de limpeza concluída. {} tokens antigos foram deletados permanentemente do banco de dados.",
        deletedCount);
  }
}
